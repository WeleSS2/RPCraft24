...
#Traits
val Tamer=mods.compatskills.TraitCreator.createTrait("tamer", 2, 0, "compatskills:beastmaster", 2);
Tamer.name = "Tamer instinct";
Tamer.description = "Allow to tame some creatures.";
Tamer.icon = "reskillable:textures/tamer.png";

val Beast=mods.compatskills.TraitCreator.createTrait("beast", 2, 1, "compatskills:beastmaster", 3);
Beast.name = "Beast tamer";
Beast.description = "Allow to tame greater monsters.";
Beast.icon = "reskillable:textures/beast.png";

val Dragon=mods.compatskills.TraitCreator.createTrait("dragonraider", 2, 2, "compatskills:beastmaster", 3);
Dragon.name = "Dragon tamer";
Dragon.description = "Allow to tame dragons.";
Dragon.icon = "reskillable:textures/dragon.png";

val Summon=mods.compatskills.TraitCreator.createTrait("summoner", 3, 0, "compatskills:beastmaster", 3);
